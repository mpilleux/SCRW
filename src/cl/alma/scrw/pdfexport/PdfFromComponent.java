...
public class PdfFromComponent {
	...
	public void export(Component c, boolean deletable) 
	{	
		List<Component> list = new ArrayList<Component>();
		list.add(c);
		this.export( list, deletable );
	...
	public void export(List<Component> list, boolean deletable ) 
	{
	...
	public void export(List<Component> list) {
		...
		try {
			Logger log = Logger.getLogger(SystemCheckInconsistenciesServiceTask.class
					.getName());
			log.log(Level.INFO, "tempFile: "+this.tempFile );
			log.log(Level.INFO, "App: "+app );
			resource = new TemporaryFileDownloadResource(app, "export.pdf",
					"aplication/pdf", this.tempFile, this.deletable );

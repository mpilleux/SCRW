...
/**
 * This class extends AbstractTasksViewImpl.
 * 
 * This class is the view implementation of MyTaskView. The associated presenter is MyTaskPresenter.
 * 
 *  This class intends allow for tasks to be started, which means that it is able to open forms.
 *
 */
public class MyTasksViewImpl extends
	...
	{
		/*return new String[] { "id", "name", "Title","description", "priority",
				"dueDate", "createTime", "assignee" };*/
		return new String[] { "id", "name", "title","description", 
				"createTime", "assignee" };
	}
